...
# carregamento ----
source(file = "./R/FUNA_Eventos_RRR_RFP.R")
source(file = "./R/Funcoes_Consumidores.R")
source(file = "./R/Funcoes_de_Formatacao_Estilo.R")
source(file = "./R/graficos_AMB.R")
source(file = "./R/Funcoes_Producao.R")
source(file = "./R/Funcoes_Reserva.R")
source(file = "./R/Abatimento_Reserva_Producao.R")
source(file = "./R/Funcoes_VPM.R")
source(file = "./R/carregamento_Bases_AMB_outras.r") 
