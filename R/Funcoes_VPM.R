...
valor_VPM_GERAL <-
  function(Substancia.AMB = ".",
    ...
    if (volume == "producao") {
      x <-
        spread(
          select(VPM_QuantidadeValorCOMERCIALIZADO[grepl(VPM_QuantidadeValorCOMERCIALIZADO$Substancia.AMB, pattern = Substancia.AMB, ignore.case = TRUE) == TRUE &
                                                     grepl(VPM_QuantidadeValorCOMERCIALIZADO$Substancia.RAL, pattern = Substancia.RAL, ignore.case = TRUE) == TRUE &
                                                     grepl(VPM_QuantidadeValorCOMERCIALIZADO$CPF.CNPJ.Titular, pattern = CPF.CNPJ.Titular, ignore.case = TRUE) == TRUE &
                                                     grepl(VPM_QuantidadeValorCOMERCIALIZADO$Municipio, pattern = Municipio, ignore.case = TRUE) == TRUE &
                                                     grepl(VPM_QuantidadeValorCOMERCIALIZADO$Produto.Comercializado, pattern = Produto.Comercializado, ignore.case = TRUE) == TRUE &
                                                     grepl(VPM_QuantidadeValorCOMERCIALIZADO$Tipo.Empreendimento, pattern = Tipo.Empreendimento, ignore.case = TRUE) == TRUE &
                                                     grepl(VPM_QuantidadeValorCOMERCIALIZADO$Nome, pattern = Nome, ignore.case = TRUE) == TRUE,], everything()) %>%
